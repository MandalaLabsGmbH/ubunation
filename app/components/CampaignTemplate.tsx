...
import BecomeVoiceModal from './BecomeVoiceModal'; // Import the new modal component
...
export default function CampaignTemplate({ collectible, sponsors }: CampaignTemplateProps) {
  ...
  return (
    <>
                    ...
                    <Card className="bg-card p-10 shadow-lg rounded-lg">
                        ...
                        <div className="text-center mt-12">
                            <Button onClick={() => setIsVoiceModalOpen(true)}>
                                {translate("campaignTemplate-becomeVoiceButton-1")}
                            </Button>
                        </div>
                    </Card>
                  </div>
      ...
      {/* The Modal itself */}
      <BecomeVoiceModal isOpen={isVoiceModalOpen} onClose={() => setIsVoiceModalOpen(false)} />
    </>
  )
}